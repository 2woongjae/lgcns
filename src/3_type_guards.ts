...
각각의 toast 를 문자열로 리턴하는 것으로 가정하고, 해당 로직을 작성하세요.
toasts 를 돌며 toast 를 꺼내서 toast 의 타입이 AFTER_PUBLISHED 인 경우, "퍼블리시가 된 직후에 뜬다!!" 라고 문자열을 만들어냅니다.

해당 함수를 안전하게 완성해주세요 (ToastType 이 추가된 경우에도 안전하도록 작성해보세요.)
*/

function convert(toasts: Toast[]): string[] {}
